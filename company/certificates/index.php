...
$APPLICATION->SetPageProperty("description", "Сертификаты компании представленные на сайте Медкомпания.рф");
$APPLICATION->SetPageProperty("title", "Сертификаты | Медкомпания.рф");
