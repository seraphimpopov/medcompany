                ...
                switch ($rowData['VARIANT']) {
                    ...
                    case 2:
                        ...
                        <div class="row">
                            ...
                            foreach ($rowItems as $item) {
                                ?>
                                <div class="catalog_row_item col-xs-6">
                                    <?
                                    $APPLICATION->IncludeComponent(
                                        'bitrix:catalog.item',
                                        'item',
                    ...
                    case 3:
                        ...
                        <div class="col-xs-12 product-item-small-card">
                            <div class="row">
                                ...
                                foreach ($rowItems as $item) {
                                    ?>
                                    <div class="col-xs-6 col-md-3 col-6" style="margin-bottom: 20px">
                                        <?
                                        $APPLICATION->IncludeComponent(
                                            'bitrix:catalog.item',
                                            'item',
                    ...
                    case 6:
                        ...
                        <div class="col-xs-12 product-item-small-card">
                            <div class="row">
                                ...
                                foreach ($rowItems as $item) {
                                    ?>
                                    <div class="col-6 col-xs-6 col-sm-4 col-md-2" style="margin-bottom: 20px">
                                        <?
                                        $APPLICATION->IncludeComponent(
                                            'bitrix:catalog.item',
                                            'item',
