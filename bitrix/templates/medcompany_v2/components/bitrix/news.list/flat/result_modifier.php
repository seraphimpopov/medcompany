...
foreach ($arResult["ITEMS"] as $arItem) {
    $path = CFile::GetFileArray($arItem['PREVIEW_PICTURE']['ID']);
    $arResult['IMAGES'][] = CFile::ResizeImageGet($path, array("width" => 331, "height" => 369), BX_RESIZE_IMAGE_PROPORTIONAL_ALT, false);
}