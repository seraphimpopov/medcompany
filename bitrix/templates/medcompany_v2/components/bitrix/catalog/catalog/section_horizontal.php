            ...
            if (!isset($isHaveSections)) {
                if ($isFilter): ?>
                    <div class="row">
                        <div class="col<?= (isset($arParams['FILTER_HIDE_ON_MOBILE']) && $arParams['FILTER_HIDE_ON_MOBILE'] === 'Y' ? ' d-none d-sm-block' : '') ?>">
                            <? $APPLICATION->IncludeComponent("bitrix:catalog.smart.filter", "smart.mobile.filter", array(
                ...
                <div class="row">
                    <div class="col">
                        ...
                        $intSectionID = $APPLICATION->IncludeComponent("bitrix:catalog.section", "section", array(
                            "IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
                            "IBLOCK_ID" => $arParams["IBLOCK_ID"],
                        ...
                        if (!isset($arParams['USE_BIG_DATA']) || $arParams['USE_BIG_DATA'] != 'N') {
                            ...
                            <div class="row">
                                <div class="col" data-entity="parent-container">
                                    <div class="catalog-block-header" data-entity="header" data-showed="false"
                                         style="display: none; opacity: 0;"><?= GetMessage('CATALOG_PERSONAL_RECOM') ?></div>
                                    <? $APPLICATION->IncludeComponent(
